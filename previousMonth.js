 ...
 /* var plot1 = $.jqplot('chart1', [line1], {
  ...
  function bindTooltip(id)
  {
	...
	function ListWeek(){
		...
		var tbClients = weeks[weeks.length-1];//Retrieve the stored data
	...
	function ListMonth(){
		...
		for(var i in oldWeeks){
			...
			if(cliDate.getMonth() == currentMonth-1)
			{
				var temp = new Array();
		...
		$('#totalMonthHours').html(Math.floor(totalMonthMinutes/60))
		$('#totalMonthDays').html(totalDaysCalculated)
	}
});